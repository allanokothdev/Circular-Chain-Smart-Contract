...
use near_sdk::{env, ext_contract, init, near_bindgen, setup_alloc, Promise};
...
const BANKCONTRACT_XCC_GAS: u64 = 5_000_000_000_000;
const BANKCONTRACT_DEPOSIT: u128 = 0;
...
impl Default for CircularChain {
    fn default() -> Self {
        panic!("Contract should be initialized")
    }
}
...
impl CircularChain {
    ...
    pub fn create_brand(
        ...
        // Checks if the brands collection contains a Brand associated with a given BrandID
    ...
    pub fn update_product(
        ...
        let initial_storage = self.initial_storage();
        assert!(
            stakeholders.contains(&signer),
            "You do not have permission to publish to edit this Item"
        );
...
mod tests {
    ...
    fn get_brand_params() -> (String, String, String, String, Vec<String>, Vec<String>, String) {
        ...
        let region: Vec<String> = Vec::new();
        let certificates: Vec<String> = Vec::new();
        let publisher: String = String::from("allanokoth.testnet");
        (image, title, summary, industry, region, certificates, publisher)
    }

    fn get_stages_params() -> (String, String, String, String, f64, f64, String, Timestamp ,Vec<String>, u8, u8, u8, u8, u8) {
        ...
        let waste: u8 = 4;
        let workers: u8 = 4;
        (stage_id, title, description, location, latitude, longitude, publisher, date, ingredients, climate, community, nature, waste, workers)
    }

    fn get_products_params() -> (String, String, String, String, String, String, Timestamp ,u8, Vec<String>, Vec<Stage>) {
        ...
        let date: Timestamp = 0;
        let rating: u8 = 0;
        let stakeholders: Vec<String> = Vec::new();
        let stages: Vec<Stage> = Vec::new();
        (product_id, image, title, summary, category, brand_id, date, rating, stakeholders, stages)
    }
    ...
    fn add_read_brands() {
        ...
        contract.create_brand(params.1.clone(), params.0, params.1.clone(), params.2, params.3, params.4, params.5);   
    ...
    fn add_delete_brands() {
        ...
        if let Some(brands) = contract.read_brands() {
            ...
            assert!(brands.contains_key(&test_params.1), "Brand Key has been deleted");
        } else {
            log(b"Error in the code");
        }
    }
    ...
    fn add_read_delete_products() {
        ...
        contract.create_product(params.0, params.1, params.2, params.3, params.4, params.5, params.6, params.7, params.8, params.9);
    ...
    fn add_read_stage() {
        ...
        let product_params = get_products_params();

         //CREATE PRODUCT OPERATION
        contract.create_product(product_params.0, product_params.1, product_params.2, product_params.3, product_params.4, product_params.5, product_params.6, product_params.7, product_params.8, product_params.9);
        
        //CREATE STAGE
        contract.create_stage(0, params.0, params.1, params.2, params.3, params.4, params.5, params.6, params.7, params.8, params.9, params.10, params.11, params.12, params.13);
